...
1	pbkdf2_sha256$100000$cfVwkoaEA0qZ$ifBessa4q1JayTw0Y0w8837IDgDnmGd0jZUz3N3oFa8=	2021-11-03 18:29:48.357611+00	t	admin			admin@example.com	t	t	2021-10-21 20:02:28.180873+00
\.
...
1161	241	es	1	2021-11-04 05:10:17.580833+00
\.
...
SELECT pg_catalog.setval('public.backend_rule_id_seq', 1161, true);
...
1293	108	30	t	Put down held block	20
\.
...
SELECT pg_catalog.setval('public.backend_state_id_seq', 1293, true);
...
4204	116	29	20	0	I am in the Patio?
...
SELECT pg_catalog.setval('public.backend_trigger_id_seq', 4205, true);
