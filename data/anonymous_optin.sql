...
SELECT pg_catalog.setval('public."backend_esrule_triggersS_id_seq"', 842, true);
...
484	2021-11-09 08:03:54.69845+00	116	Capability object (116)	2	[{"changed": {"fields": ["name", "statelabel", "commandlabel", "eventlabel"]}}]	14	1
